...
#backup CONSUL_FLAGS="-server -bootstrap-expect=${SERVER_COUNT} -join=${CONSUL_JOIN} -data-dir=/opt/consul/data"
CONSUL_FLAGS="-server -bootstrap-expect=${SERVER_COUNT} -data-dir=/opt/consul/data"
EOF
